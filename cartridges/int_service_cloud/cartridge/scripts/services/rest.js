...
const endpoints = {
    ...
    create: {
        account: 'services/apexrest/NSSCCConnector/Contact/Registration',
        case: 'services/apexrest/NSSCCConnector/Case',
        order: 'services/apexrest/NSSCCConnector/Order/Placement'
    },
    update: {
        account: 'services/apexrest/NSSCCConnector/Contact/Registration',
        case: 'services/apexrest/NSSCCConnector/Case',
...
var getDefinition = {
     ...
     * @param {String} endpoint
     */
    createRequest: function (svc, endpoint) {
        setAuthHeader(svc, endpoint);
        svc.addHeader('Content-Type', 'application/json');
        svc.setRequestMethod('GET');
    },
