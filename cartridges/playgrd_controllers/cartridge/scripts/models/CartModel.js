...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions, quantity) {
        ...
        var UpdateProductOptionSelections = require('playgrd_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('playgrd_core/cartridge/scripts/cart/ValidateCartForCheckout');
